export default [
  {
    selector: '[data-tut="widget-name-input"]',
  ...
  },
  {
    ...
    content: 'A series is a set of data, for example a line graph or one set of columns. All data plotted on a chart comes from the series object',
  },
  {
    selector: '[data-tut="widget-serie-name-input"]',
    content: 'The name attribute gives the series a name, which show up when hovering over the series in a chart and in the legend.',
  },
  {
    selector: '[data-tut="widget-serie-color-input"]',
    content: 'Allows changing the color of a series.',
  },
  {
